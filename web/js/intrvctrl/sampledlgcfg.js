...
Sampledlg.SUBJ_TYPE = 1
Sampledlg.SAMPLE_TYPE = 2
Sampledlg.FAMILY_TYPE = 3

Sampledlg.PRJ_SIZE = 3
Sampledlg.SUBJ_TYPE_SIZE = 1
Sampledlg.HOSP_SIZE = 2
Sampledlg.SUBJ_CODE_SIZE = 3	
Sampledlg.FULL_SUBJ_CODE_SIZE = 9
Sampledlg.SAMPLE_XTRA_SIZE = 2	
Sampledlg.FAM_XTRA_SIZE = 3
...
Sampledlg.TxtCode = Ext.extend(Ext.form.TextField, {
	...
	constructor: function (config) {
		...
		var codeSize = config.codeSize? config.codeSize: 
										Sampledlg.FULL_SUBJ_CODE_SIZE + Sampledlg.SAMPLE_XTRA_SIZE;
		var maxChars = '"'+codeSize+'"';
		var myregex = new RegExp('\\w{'+Sampledlg.PRJ_SIZE+'}\\d+');
		var myCfg = {
	// validation
			maskRe: /\w/,
			regex: myregex,
